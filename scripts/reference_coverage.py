...
Why this exists: the day-2 export reported 1/6 and the day-4 export 3/3, against anchor
sets that were neither the same nor the full eligible set (S3's DOI had to be resolved from
its PII; S6's DOI from its PMC page). Both exports in fact returned S1, S2, S3 and S5.
Actual: 4/6 and 4/6. This script fixes the denominator and is the number the docs cite.
