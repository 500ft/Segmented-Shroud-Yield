...
Question axes: Equal mean clearance with discrete seams versus smooth/nonuniform clearance; actual aerodynamic measurements versus CFD; deployment-specific versus fixed geometry; matched controls; held-out prediction; independently tested guard claims.
