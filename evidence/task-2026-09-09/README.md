# SSY-D02 verification — 2026-09-09
...
| Item | Observed |
| --- | --- |
| unique records retained | 499 |
| overlap with the 6 resolvable D01 identifiers | 1 |
| query legs failing | arXiv search API: 6/6 (HTTP 429); Crossref 0; OpenAlex 0 |
