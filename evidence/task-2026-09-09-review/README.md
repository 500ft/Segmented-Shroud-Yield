# SSY-D02 review correction — 2026-09-09

Review base: `0d1e4bc91a90d03db12ce66c2055e11191737ab0`; branch `review/day-two-20260909`.
...
| Historical export audit below | exit 1, expected: 50 unmatched provenance rows |
...
```sh
python evidence/task-2026-09-09/rerun_search.py --out /tmp/ssy-new-search-20260909
```
