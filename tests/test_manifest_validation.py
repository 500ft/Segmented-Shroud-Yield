...
EXAMPLE = ROOT / "protocols/example-specimen-manifest.json"
...
class ManifestValidationTests(unittest.TestCase):
    ...
    def test_schema_rejects_invalid_nested_values(self):
        ...
        cases = [[["deployment_cycle"],-10],[["deployment_cycle"],True],[["defect_field","mean_clearance_mm"],-1],[["defect_field","family"],"unknown"],[["closure","preload_n"],-0.1],[["rotor_system"],{}],[["defect_field","mean_clearance_mm"],"NaN"],[["defect_field","mean_clearance_mm"],"Infinity"]]
    ...
    def test_nested_required_field_is_enforced(self):
        ...
        del example["rotor_system"]["rotor_id"]
